...
function Home() {
    ...
    return (
        <>
            <header className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'py-3 shadow-md bg-white' : 'py-4 bg-transparent'}`}>
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center">
                        ...
                        <nav className="hidden md:flex items-center space-x-8">
                            ...
                            <a href={"#academics"} className="font-medium hover:text-indigo-600 transition-colors">Services</a>
                            <a href={"#about"} className="font-medium hover:text-indigo-600 transition-colors">About Us</a>
                            <a href={"#events"} className="font-medium hover:text-indigo-600 transition-colors">Combination</a>
                            <a href={"#contact"} className="font-medium hover:text-indigo-600 transition-colors">Contact</a>
                            <a href={"#portal"} className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-colors">text us</a>
                        </nav>
                    ...
                    <div className={`md:hidden ${menuOpen ? '' : 'hidden'} bg-gradient-to-br from-indigo-50 to-blue-50 p-2`} id="mobile-menu">
                        <div className="flex flex-col space-y-4 mt-4 pb-4">
                            <a href={"#home"} className="font-medium hover:text-indigo-600 transition-colors">Home</a>
                            <a href={"#academics"} className="font-medium hover:text-indigo-600 transition-colors">Service</a>
                            <a href={"#about"} className="font-medium hover:text-indigo-600 transition-colors">About Us</a>
                            <a href={"#events"} className="font-medium hover:text-indigo-600 transition-colors">Combination</a>
                            <a href={"#contact"} className="font-medium hover:text-indigo-600 transition-colors">Contact</a>
                            <a href={"#portal"} className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-colors inline-block text-center">text us</a>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <footer className="bg-gray-800 text-white py-12">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            <h3 className="text-xl font-bold mb-4">ecole secondary saint trinite ruhango</h3>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href={"#home"}
                                       className="text-gray-300 hover:text-white transition-colors">Home</a></li>
                                <li><a href={"#academics"}
                                       className="text-gray-300 hover:text-white transition-colors">Academics</a></li>
                                <li><a href={"#about"} className="text-gray-300 hover:text-white transition-colors">About
                                    Us</a></li>
                                <li><a href={"#events"}
                                       className="text-gray-300 hover:text-white transition-colors">Events</a></li>
                                <li><a href={"#contact"}
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Student
                                    Portal</a></li>
                                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Parent
                                    Portal</a></li>
                                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Staff
                                    Directory</a></li>
                                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">School
                                    Calendar</a></li>
                                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Library</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 mb-4">Subscribe to our newsletter to receive updates.</p>
                            <form>
                                <div className="flex">
                    ...
                    <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between">
                        <p className="text-gray-400 text-sm">
                            © 2025 Westfield High School. All rights reserved.
                        </p>
                        <p className="text-gray-400 text-sm">
                            made by ally bashir.
                        </p>
                        <div className="mt-4 md:mt-0">
                            <a href="#" className="text-gray-400 text-sm hover:text-white transition-colors mr-4">Privacy
                                Policy</a>
                            <a href="#" className="text-gray-400 text-sm hover:text-white transition-colors">Terms of
                                Service</a>
                        </div>
                    </div>
                </div>
